---
description: "Run a broad read-only project/repository audit for logic bugs, dead code, wrong fix levels, duplicate logic, test gaps, UI/API mismatches, and optimization opportunities."
agent: auditor
subtask: false
---
